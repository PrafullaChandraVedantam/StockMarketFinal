...
<ul>
  ...
  <li style="float:right"><a href="/logoutSector">Logout</a></li>
	...
	<br>
<%
		String sectorCode = request.getParameter("sectorId");
		int sectorId = Integer.parseInt(sectorCode);
	%>
	<div class="container register-form">
		<form:form method="GET" action="/updateSector" modelAttribute="updateSector">
			<div class="note">
				<p>Sector Updation Form</p>
			</div>
